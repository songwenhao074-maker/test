# 当前上下文：Protocol-027 / data revision 002

目标仍是在合理业务更替场景下检验动态残差专家D相对固定残差专家C的优势。当前单任务只有C_fixed5与D_dynamic、seed700/model1；方法、业务规律、时间线及评分规则不变。

原数据登记版本缺少完整保全且无法可靠重现文件哈希。用户于2026-09-22授权采用独立的新数据版本：既存恢复文件fdea8430…/21cd7335…。其与旧完整数据的等价性未知；旧登记与失败记录保留。
