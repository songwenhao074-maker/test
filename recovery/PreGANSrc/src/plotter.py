import matplotlib
matplotlib.use('Agg')  # non-interactive backend — avoids tkinter memory issues on headless systems
import matplotlib.pyplot as plt
import scienceplots  # Registers the "science" and "ieee" matplotlib styles.
...
class Model_Plotter():
	def __init__(self, env, modelname):
		...
		self.tsne = TSNE(n_components=2, perplexity=50, max_iter=1000)
		self.colors = ['r', 'g', 'b']
