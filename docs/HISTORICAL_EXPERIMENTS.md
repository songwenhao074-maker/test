...
当前唯一入口：[Protocol-031 revision002新场景](PROTOCOL031_SINGLE_TASK_DIRECTIVE_20260922.md)及[当前交接](GITHUB_EXPERIMENT_HANDOFF.md)。历史指令不自动构成当前任务。
...
| 031 revision002 | 当前唯一任务：一个新稀有回归场景＋C/D各一次；见[修订记录](PROTOCOL031_PLAN_REVISION_002_20260922.md) |
